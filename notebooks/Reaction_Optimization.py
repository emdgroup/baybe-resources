...
def _(mo):
    mo.md("""
    ## Defining the [`Parameters`](https://emdgroup.github.io/baybe/0.15.0/components/parameters.html)
...
def _(mo):
    mo.md("""
    ## Define the [`SearchSpace`](https://emdgroup.github.io/baybe/0.15.0/components/searchspace.html)
...
def _(mo):
    mo.md(r"""
    ## Define the [`Target`](https://emdgroup.github.io/baybe/0.15.0/components/targets.html) & objective

    In this example, we want to maximize the yield of the reaction. Since we are only optimizing a single objective, we use the [`SingleTargetObjective`](https://emdgroup.github.io/baybe/0.15.0/components/objectives.html#singletargetobjective) which assumes a maximization of the target as default.
    """)
    return
...
def _(mo):
    mo.md(r"""
    ## Define the [`Recommender`](https://emdgroup.github.io/baybe/0.15.0/components/recommenders.html)

    The [`Recommender`](https://emdgroup.github.io/baybe/0.15.0/components/recommenders.html) selects the next set of experiments to try.
    There are many different recommenders offered by `BayBE`, and a lot of ways of combining them. For this example, we use a [`TwoPhaseMetaRecommender`](https://emdgroup.github.io/baybe/0.15.0/_autosummary/baybe.recommenders.meta.sequential.TwoPhaseMetaRecommender.html) equipped with a [`BotorchRecommender`](https://emdgroup.github.io/baybe/0.15.0/_autosummary/baybe.recommenders.pure.bayesian.botorch.core.BotorchRecommender.html) that uses the [`EDBOKernel`](https://emdgroup.github.io/baybe/0.15.0/_autosummary/baybe.surrogates.gaussian_process.presets.edbo.EDBOKernelFactory.html). The EDBO kernel is particularly well-suited for chemical optimization problems as it was specifically designed to handle chemical descriptors effectively.
    """)
    return
...
def _(mo):
    mo.md(r"""
    ## Define the [`Campaign`](https://emdgroup.github.io/baybe/0.15.0/components/campaigns.html)
...
def _(mo):
    mo.md(r"""
    ## Starting [the recommendation loop](https://emdgroup.github.io/baybe/0.15.0/concepts/getting_recommendations.html)
...
def _(mo):
    mo.md(r"""
    ### Using BayBE's [simulation capabilities](https://emdgroup.github.io/baybe/0.15.0/concepts/simulation.html)
